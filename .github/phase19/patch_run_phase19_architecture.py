...
new_block=r'''# Evidence-derived performance acceptance using the generic source-vs-runtime two-layer model.
# Raw median failures do not terminate before source-graph/runtime-graph adjudication.
...
print('Phase 19 final run patched: source graph vs runtime graph generic adjudication; no route-specific diagnostic reruns; sections 67-80 enabled.')
