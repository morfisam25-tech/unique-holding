...
(async()=>{
  ...
  for(const c of cases){
    ...
    await page.waitForFunction(sel=>{const img=document.querySelector(sel+' img');return !!img&&img.complete&&img.naturalWidth===1920&&img.naturalHeight===1080;},{timeout:15000},selector);
